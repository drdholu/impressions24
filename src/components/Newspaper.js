...
import image1 from '../images/memories/sabali7.webp'
...
const ImpressionsNewspaper = () => {
    return (
        <div className="max-w-6xl p-8 mx-auto font-serif">
            <CrumpledPaperBackground />
            <h1 className="mb-8 text-6xl text-center transition-colors duration-300 font-playfair hover:text-gray-700">
