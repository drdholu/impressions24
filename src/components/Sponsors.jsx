...
import cafericoco from './images/MODULE_IMAGES/sponsors1/cafe_ricoco.webp'
...
import cubanos from './images/MODULE_IMAGES/sponsors2/cubanos.webp'
...
const sponsorsData = {
  ...
  "Food Sponsors": [
    { name: "Cafe RICOCO", photo: cafericoco, description: "Media Coverage Partner",link:`https://www.cognavi.com/` },
    { name: "Amadas Empanadas", photo: amadas, description: "Media Coverage Partner" ,link:`https://www.cognavi.com/`},
    { name: "Anazori - The Kitchen", photo: anazori, description: "Media Coverage Partner",link:`https://www.cognavi.com/` },
    { name: "Rajeshahi Samosa", photo: rajeshahi, description: "Media Coverage Partner",link:`https://www.cognavi.com/` },
    { name: "Ginger Lemon", photo: ginger, description: "Media Coverage Partner",link:`https://www.cognavi.com/` },
    { name: "Cafe Melt", photo: melt, description: "Media Coverage Partner",link:`https://www.cognavi.com/` },
    { name: "Soda Monkey", photo: soda, description: "Media Coverage Partner",link:`https://www.cognavi.com/` },

  ],
  "Other Sponsors": [
    { name: "Cubanos", photo: cubanos, description: "Miscellaneous",link:`https://www.cognavi.com/` },
