...
import Gl from '../../GL/something';

import {FireFlyMaterial} from './fireflymaterail';
...
export class FireFlies {
	 ...
	 */
	constructor(_scene, props = defaultProps) {
	 ...
	 */
	setInitialPositions(groupCount, firefliesPerGroup) {
